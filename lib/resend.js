...
function layout({ title, bodyHtml }) {
  return (
    ...
    '<a href="https://starfobar.vercel.app" style="color:#F5F5F5;text-decoration:underline;">starfobar.vercel.app</a>' +
...
function newsletterEmail(email) {
  ...
  const html = layout({
    ...
    bodyHtml:
      ...
      '<a href="https://starfobar.vercel.app" style="display:inline-block;background:#E30613;color:#fff;' +
